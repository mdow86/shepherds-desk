...
VOICE_DEFAULT  = os.getenv("ELEVEN_VOICE", "cVd39cx0VtXNC13y5Y7z")  # set your default
...
def ext_for(fmt: str) -> str:
    ...
    if f.startswith("pcm"):  return ".wav"   # raw PCM wrapped into WAV
...
def pcm_samplerate(fmt: str) -> int:
    try:
        return int((fmt or "").split("_", 1)[1])  # "pcm_44100" -> 44100
    except Exception:
        return 44100
